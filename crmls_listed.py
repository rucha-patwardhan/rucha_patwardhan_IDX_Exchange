...
listings_jan = pd.read_csv('CRMLSListing202401.csv')
listings_feb = pd.read_csv('CRMLSListing202402.csv')
sold_jan = pd.read_csv('CRMLSSold202401.csv')
sold_feb = pd.read_csv('CRMLSSold202402.csv')